...
for row in datos_hoja_calculo:
    ...
    with open(temp_file, "w") as f:
        ...
        def run_script(script_name, temp_file):
            try:
                ...
                if nombre_archivo:
                    ...
                    file_path_src = os.path.join(r"C:\Users\ramon\Descargas", file_name)
        ...
        if run_script("BCI_v1.py", temp_file):
            ...
            print(
                "Todos los scripts se ejecutaron correctamente y los archivos PDF se descargaron en la carpeta del asegurado.")
